...
var versionLog = []fcallMsg{
	...
	{kind: SR, f: plan9.Fcall{Type: plan9.Tversion, Tag: 65535, Msize: 8092, Version: "9P2000"}},
	{kind: SW, f: plan9.Fcall{Type: plan9.Rversion, Tag: 65535, Msize: 8092, Version: "9P2000"}},
}
...
var testLog = []fcallMsg{
	...
	{kind: CW, f: plan9.Fcall{Type: plan9.Twalk, Tag: 2, Fid: 1, Newfid: 2, Wname: []string{"ctl"}}},
	{kind: SR, f: plan9.Fcall{Type: plan9.Twalk, Tag: 2, Fid: 1, Newfid: 2, Wname: []string{"ctl"}}},
	{kind: SW, f: plan9.Fcall{Type: plan9.Rwalk, Tag: 2, Wqid: []plan9.Qid{{Path: 1, Vers: 0, Type: 0}}}},
	{kind: CR, f: plan9.Fcall{Type: plan9.Rwalk, Tag: 2, Wqid: []plan9.Qid{{Path: 1, Vers: 0, Type: 0}}}},

	// Server sees a Topenfd as Topen
	{kind: CW, f: plan9.Fcall{Type: plan9.Topenfd, Tag: 2, Fid: 2, Mode: plan9.OREAD}},
	{kind: SR, f: plan9.Fcall{Type: plan9.Topen, Tag: 2, Fid: 2, Mode: plan9.OREAD}},
	{kind: SW, f: plan9.Fcall{Type: plan9.Ropen, Tag: 2, Qid: plan9.Qid{Path: 1, Vers: 0, Type: plan9.QTDIR}, Iounit: 1024}},
	{kind: CR, f: plan9.Fcall{Type: plan9.Ropenfd, Tag: 2, Qid: plan9.Qid{Path: 1, Vers: 0, Type: plan9.QTDIR}, Iounit: 1024, Unixfd: 3}},

	// mux will read for client for the openfd pipe. Server sends EOF and mux clunks the fid.
	{kind: SR, f: plan9.Fcall{Type: plan9.Tread, Tag: 2, Fid: 2, Offset: 0, Count: 8068}},
	{kind: SW, f: plan9.Fcall{Type: plan9.Rread, Tag: 2, Count: 0, Data: nil}},
	{kind: SR, f: plan9.Fcall{Type: plan9.Tclunk, Tag: 2, Fid: 2}},
	{kind: SW, f: plan9.Fcall{Type: plan9.Rclunk, Tag: 2}},
...
func replayLog(t *testing.T, l []fcallMsg, srv io.ReadWriter, cli io.ReadWriter) {
	...
	for _, m := range l {
		...
		if r != nil {
			...
			if m.kind == CR && m.f.Type == plan9.Ropenfd {
				m.f.Unixfd = f.Unixfd // ignore Unixfd
				_, err := ReceiveFD(r.(*net.UnixConn))
				if err != nil {
